...
= 1.5.9 =
* Correcao: na aba Selecao de Midia, o botao "Salvar configuracoes" (que nao grava a selecao e recarregava) fica oculto; o salvar correto ali e o "Salvar selecao".

= 1.5.8 =
* A mensagem de "Salvo" mostra o modo gravado (proteger tudo x so as selecionadas).

= 1.5.7 =
* Correcao definitiva: o modo "so as selecionadas" nao volta mais sozinho para "proteger tudo" — o plugin passa a ser o dono do escopo e da lista, e o sync do painel nao sobrescreve.

= 1.5.6 =
* UX: no modo "so as selecionadas" sem imagens marcadas, o plugin agora orienta em vez de reverter em silencio para "proteger tudo".
...
= 1.5.3 =
* Selecao de Midia: filtro "Ver" (Todas / Marcadas / Sem marca) para revisar a IA — cacar falso positivo ou conferir o que passou.
